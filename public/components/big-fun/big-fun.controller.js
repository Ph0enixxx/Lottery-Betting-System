(function() {
  ...
  function BigFunController(appUtils, Lottery) {
    ...
    ballCtrl.redAwardBalls = _.range(10,15);
    ballCtrl.blueAwardBalls = _.range(8,10);
    ...
    function selectBall(ball, color) {
      ...
      ballCtrl.betCount  = appUtils.computeCxy(ballCtrl.colorBallStat[RED_BALL], NEED_RED_NUM) *
                           appUtils.computeCxy(ballCtrl.colorBallStat[BLUE_BALL], NEED_BLUE_NUM);
